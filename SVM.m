function [test_targets, a_star] = SVM(train_patterns, train_targets, test_patterns, kernel, ker_param, solver, slack)

%  support vector machine algorithm 
% 
% Inputs:
% 	train_patterns	- 训练数据集
%	train_targets	- 训练数据标签
%   test_patterns   - 测试数据集
%	params	        - 参数表：kernel为核，可以选择： Gauss, RBF (Same as Gauss), Poly, Sigmoid, or Linear
%                       ker_param  are:
